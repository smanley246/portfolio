  ...
  export const aboutPageData: {
    ...
    sections: [
  ...
  
      {
        ...
        pitch:
          "I’m strongest when a project needs someone who can jump from requirements → architecture → implementation, whether that’s firmware, FPGA logic, or a clean full-stack app.",
        skillGroups: [
          {
  ...
  
      {
        ...
        cards: [
          {
            title: "Squash",
            body: ["Squash has been a huge part of my life. Competing has taught me consistency, composure under pressure, and how to keep improving over time. I bring that same mindset into engineering projects: train the fundamentals, iterate quickly, and show up prepared.",
          ...
          },
          {
            ...
            body: "I genuinely enjoy staying current with new tech; from embedded platforms and tools to modern app stacks. I like exploring how systems work end-to-end, and I’m always looking for better ways to build, test, and ship clean solutions.",
            tags: ["Cutting Edge Tech", "Systems Thinking", "Efficient Solutions"],
          },
          {
            title: "Pets",
            body: "I’m a big animal person. My pets keep life balanced and remind me to step away from the screen once in a while. They’re also a good reminder that the best routines are consistent, simple, and sustainable.",
